...
var _Entry = _interopRequireDefault(require("../nodes/Entry"));
...
const parseEntry = (_ref) => {
  ...
  const entry = _Entry.default.parse(context, tokenList);

  const parsedTokenList = (0, _generateTokenList.default)(context, {
    ast: entry
  });
  return _objectSpread(_objectSpread({}, rest), {}, {
    children: (0, _ramda.append)(entry, children),
    context,
    entry,
...
var _default = parseEntry;
exports.default = _default;
//# sourceMappingURL=parseEntry.js.map