...
const UNARY_OPERATOR_PARSERS = [_LogicalNotOperator.default, _UnaryMinusOperator.default, _UnaryPlusOperator.default];

const parseUnaryOperator = (_ref) => {
  let {
    children,
    context,
    tokenList
  ...
  const operator = (0, _parseNextNode.default)(UNARY_OPERATOR_PARSERS, context, tokenList);
...
var _default = parseUnaryOperator;
exports.default = _default;
//# sourceMappingURL=parseUnaryOperator.js.map