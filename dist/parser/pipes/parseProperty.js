...
const PROPERTY_PARSERS = [_Range.default, _Expression.default, _Identifier.default, _Literal.default];
const parsePropertyNode = (0, _util.parseNextNode)(PROPERTY_PARSERS);
...
const parseProperty = props => {
  ...
  return _objectSpread(_objectSpread({}, props), {}, {
    children: (0, _ramda.append)(property, children),
    property,
    tokenList: (0, _ramda.slice)(parsedTokenList.size, tokenList.size, tokenList)
  });
};

var _default = parseProperty;
exports.default = _default;
//# sourceMappingURL=parseProperty.js.map