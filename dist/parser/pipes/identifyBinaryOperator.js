...
const BINARY_OPERATOR_IDENTIFIERS = [_DivideOperator.default, _EqualityOperator.default, _GreaterThanEqualOperator.default, _GreaterThanOperator.default, _InequalityOperator.default, _InOperator.default, _IsOperator.default, _LessThanEqualOperator.default, _LessThanOperator.default, _LogicalAndOperator.default, _LogicalOrOperator.default, _ModulusOperator.default, _MultiplyOperator.default, _UnaryMinusOperator.default, _UnaryPlusOperator.default];
const identifyBinaryOperatorNode = (0, _util.identifyNextNode)(BINARY_OPERATOR_IDENTIFIERS);

const identifyBinaryOperator = (_ref) => {
  let {
    children,
    context
  } = _ref,
...
var _default = identifyBinaryOperator;
exports.default = _default;
//# sourceMappingURL=identifyBinaryOperator.js.map