...
var _IfStatement = _interopRequireDefault(require("../nodes/IfStatement"));
...
const parseIfStatement = (_ref) => {
  ...
  const statement = _IfStatement.default.parse(context, tokenList);

  const parsedTokenList = (0, _generateTokenList.default)(context, {
    ast: statement
  });
  return _objectSpread(_objectSpread({}, rest), {}, {
    children: (0, _ramda.append)(statement, children),
    context,
    statement,
...
var _default = parseIfStatement;
exports.default = _default;
//# sourceMappingURL=parseIfStatement.js.map