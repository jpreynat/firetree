...
const LITERAL_PARSERS = [_Literal.default];
const parseLiteralNode = (0, _util.parseNextNode)(LITERAL_PARSERS);

const parseLiteral = (_ref) => {
  let {
    children,
    context,
    tokenList
  ...
  children = (0, _ramda.append)(literal, children);
...
var _default = parseLiteral;
exports.default = _default;
//# sourceMappingURL=parseLiteral.js.map