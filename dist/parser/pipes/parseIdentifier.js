...
const parseIdentifier = (_ref) => {
  ...
  const identifier = _Identifier.default.parse(context, tokenList);

  const parsedTokenList = (0, _generateTokenList.default)(context, {
    ast: identifier
  });
  return _objectSpread(_objectSpread({}, rest), {}, {
    children: (0, _ramda.append)(identifier, children),
    context,
    identifier,
